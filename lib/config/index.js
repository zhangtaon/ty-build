...
let geoserver, hls, videoHttp, authHttp, dictionHttp, gatewayHttp, troubleHttp, workHttp, alarmHttp, riskHttp;
/**
 * 获取直播地址
 * @param {String} url 
 */
...
function setAxiosBaseUrl(url) {
    ...
    alarmHttp = axios.create({
        baseURL: url + gateway.alarm
    });
    riskHttp = axios.create({
        baseURL: url + gateway.risk
    });
}
...
let _https = [axios, videoHttp, authHttp, dictionHttp, gatewayHttp, troubleHttp, workHttp, alarmHttp, riskHttp];
...
export { geoserver, hls, videoHttp, authHttp, dictionHttp, gatewayHttp, troubleHttp, workHttp, alarmHttp, riskHttp, setHeader, appConifg }