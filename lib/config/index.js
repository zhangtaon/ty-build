...
let geoserver, hls, videoHttp, authHttp, dictionHttp, gatewayHttp, troubleHttp, workHttp, alarmHttp;
/**
 * 获取直播地址
 * @param {String} url 
 */
...
let _https = [axios, videoHttp, authHttp, dictionHttp, gatewayHttp, troubleHttp, workHttp, alarmHttp];
...
export { geoserver, hls, videoHttp, authHttp, dictionHttp, gatewayHttp, troubleHttp, workHttp, alarmHttp, setHeader, appConifg }